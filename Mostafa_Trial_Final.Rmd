...
```{r}
#filtering out the NA Behaviour_type
...
for (i in 1:nrow(start_stop_df))
{
  ...
  # extract phase duration and phase end time
  ...
  for(j in 1:nrow(filtered_phase_table))
  {
    ...
    # calculate behaviour-modifier percentage contribution per phase depending on where their 
    #start and end is located relative to phase start and end - covering all cases
...
```{r}
#add the percentages of multiple behaviour-modifier combinations occurring within the same phase
